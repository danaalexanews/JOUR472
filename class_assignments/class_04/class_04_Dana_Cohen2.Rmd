...
# data has 290,908 rows and 42 columns. "TRANSACTION_DATE <chr> "01262006", "02212006", "02212006", "06082006", "07212006", "03152…" should be a dbl. I would not need to use the code columns for any math-related issues. Missing values are Represented by "null"
...
```{r}
#The DEA proposed a revocation of the registration verification for Newcare home health servcies as a retail pharmacy on the grouds of the state of Maryland suspending thier state pharmacy license. Newcare home health services reside 3423-3425 SINCLAIR LANE and sold 6133600 between 2006 and 2012.
```
...
# The name of the distributor that sold the most pills to Baltimore City was Mckesson. They sold 58267330 pills. Mckesson HQ is located in Irving, TX.
...
#Professional Pharmacy servides located at Sinai Hospital received 3352600 pills from Mckesson. What's unique is that Professional Pharmacy services is located in a hospital would make shipments less suspicsious and more likely to recieve even more shipments.
...
#Rite Aid of Maryland, INC. received 12.52 percent of pills. The total number of pills were 16,740,590 sent to Rite Aid. The total number of pills sent to Baltimore were 133,721,503
...
# There are 3 different iterations of Rite Aid in this data set. The pharmacy names were similar to one another, causing them to group incorrectly.
...
# There were 290,908 total shipments coming in to Baltimore. 15.1 Percent went to Rite Aid stores.
...
# Actavis Pharma had a total of 957,100 pills in 67 different shipments. The avg shipment of pills was 14285. Cardinal Health Pharmacy had a total og 172800 pills in 61 different shipments. There avg was 2832 pills.
``` 
...
# Which pharmacy had 3372600 number of pills? -Walgreens.
``` 
...
# How many total pills did Bayview pharmacy have?- 3738120
```
...
#who had the third highest percentage of pills - Maryland cvs pharm
```
...
#who had the lowest percentage of pills? - Giant pharm 166 with 2%
```
## Output
